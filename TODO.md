...
- Game rarity — based on IGDB user rating (with minimum ratings)
- Powerup strength determining get %chance
- Add power-ups:
...
- Powerup usage amount could be a range instead of a set amount
- UX overhaul
