...
export function hasWesternRelease(release_dates) {
  ...
  //Check if release_dates.release_region includes any Western regions (1 = Europe, 2 = North America, 3 = Australia, 8 = Worldwide)
  return release_dates.some(rd => [1, 2, 3, 8].includes(rd.release_region));
}
